  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b"
      ...
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "11px", color: "#4ade80", background: "rgba(74,222,128,0.08)", border: "1px solid rgba(74,222,128,0.15)", padding: "3px 10px", borderRadius: 3, letterSpacing: "0.05em" }}>
          ● shelbynet
        </div>
      </div>
    </header>
