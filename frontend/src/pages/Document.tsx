...
import { fetchDoc, downloadUrl, formatBytes, shortHash, STATUS, type Doc } from "../lib/api";
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 32 }}>
            {[
              ...
              { label: "TX HASH", value: doc.txHash, link: `https://explorer.aptoslabs.com/txn/${doc.txHash}?network=shelbynet` },
